        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gradient-to-r from-light-50 to-light-200 dark:from-light-800 dark:to-light-900 overflow-hidden shadow-md sm:rounded-lg p-6">
                <div class="mb-4 flex justify-end">
                    <a href="{{ route('admin.UserManagement.create') }}" class="px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-md hover:from-purple-500 hover:to-indigo-500 rounded-md">
                        Create User
                    </a>
                </div>
                    ...
                    @forelse($users as $user)
                        <div class="bg-white dark:bg-light-800 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
                            ...
                            <div class="flex items-center mt-4 space-x-4">
                                <a href="{{ route('admin.UserManagement.edit', $user->id) }}" class="text-indigo-600 hover:text-indigo-800">
